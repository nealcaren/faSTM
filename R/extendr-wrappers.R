...
fit_stm <- function(docs_flat, doc_lens, num_types, num_topics, em_iters, em_tol, sigma_shrink, prevalence, num_features, content_groups, num_groups, content_time_num_base, content_time_num_periods, content_time_smooth, content_prior_var, content_l1, init_spectral, init_beta, gamma_l1_alpha, diagonal, seed, inference, batch_size, tau, kappa, num_threads) .Call(wrap__fit_stm, docs_flat, doc_lens, num_types, num_topics, em_iters, em_tol, sigma_shrink, prevalence, num_features, content_groups, num_groups, content_time_num_base, content_time_num_periods, content_time_smooth, content_prior_var, content_l1, init_spectral, init_beta, gamma_l1_alpha, diagonal, seed, inference, batch_size, tau, kappa, num_threads)
